...
TRANSLATIONS = {
    "de": {
        ...
        "lbl_move_source": "Quell-Spuren (2, Komma-getrennt):",
        "lbl_move_target": "Ziel-Spuren (2, Komma-getrennt):",
        "lbl_move_hint": "Verschiebt das gesamte Material per PTSL an gleiche Zeitposition. Webtrigger: /move_audio",
    ...
    "en": {
        ...
        "lbl_move_source": "Source tracks (2, comma-separated):",
        "lbl_move_target": "Target tracks (2, comma-separated):",
        "lbl_move_hint": "Moves all material via PTSL to the same time position. Web trigger: /move_audio",
        "play_custom": "Play KH2 / ST Abh",
        "log_menu_play_custom": ">>> MENU 'Play KH2 / ST Abh' <<<",
    },
    "fr": {
        ...
        "lbl_move_source": "Pistes source (2, séparées par des virgules) :",
        "lbl_move_target": "Pistes cible (2, séparées par des virgules) :",
        "lbl_move_hint": "Déplace tout le matériel via PTSL à la même position temporelle. Déclencheur web : /move_audio",
    ...
    "es": {
        ...
        "lbl_move_source": "Pistas de origen (2, separadas por comas):",
        "lbl_move_target": "Pistas de destino (2, separadas por comas):",
        "lbl_move_hint": "Mueve todo el material vía PTSL a la misma posición temporal. Disparador web: /move_audio",
    ...
    "pt": {
        ...
        "lbl_move_source": "Faixas de origem (2, separadas por vírgula):",
        "lbl_move_target": "Faixas de destino (2, separadas por vírgula):",
        "lbl_move_hint": "Move todo o material via PTSL para a mesma posição temporal. Gatilho web: /move_audio",
