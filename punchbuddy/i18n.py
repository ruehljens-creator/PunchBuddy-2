...
TRANSLATIONS = {
    "de": {
        ...
        "mon_hdr": "Play Custom – Mute-Zustände",
        "mon_desc": "Definiert welche Spuren beim Play Custom gemutet oder entmutet werden.",
        "mon_col_track": "Spur",
        "mon_col_mute_start": "Mute bei Play-Start",
        "mon_col_mute_stop": "Mute bei Stop",
        "mon_channel": "Kanal",
        ...
        "lbl_export_paths": "Export-Pfade (leer = Standard <Session>/export):",
        "lbl_wav_path": "WAV-Pfad:",
        "lbl_aaf_emb_path": "AAF Embedded-Pfad:",
        "lbl_aaf_ref_path": "AAF Reference-Pfad:",
        ...
        "tab_presets": "Presets",
        "tab_vocaster": "Vocaster",
        "lbl_vocaster_device": "Erkanntes Gerät:",
        "lbl_vocaster_phantom_start": "48V Phantomspeisung beim Start von PunchBuddy einschalten",
        "lbl_vocaster_phantom_hint": "Schaltet die 48V automatisch ein, sobald PunchBuddy startet (alle Eingänge).",
        "lbl_vocaster_autogain_urls": "Autogain-Webtrigger",
        "lbl_vocaster_autogain_host": "Autogain Host",
        "lbl_vocaster_autogain_guest": "Autogain Guest",
        "lbl_vocaster_phantom_on": "48V einschalten",
        "lbl_vocaster_phantom_off": "48V ausschalten",
        "lbl_vocaster_note": "PunchBuddy steuert den Vocaster direkt – die Vocaster Hub App wird dafür beim ersten Zugriff beendet.",
        "vocaster_menu_autogain_host": "Vocaster: Autogain Host",
        "vocaster_menu_autogain_guest": "Vocaster: Autogain Guest",
        "vocaster_menu_phantom_on": "Vocaster: 48V einschalten",
        "vocaster_menu_phantom_off": "Vocaster: 48V ausschalten",
        "vocaster_menu_save_routing": "Vocaster: Aktuelles Routing speichern",
        "lbl_vocaster_routing_hdr": "Audio-Routing (Hub-Ersatz)",
        "lbl_vocaster_routing_apply_start": "Gespeichertes Routing beim Start anwenden",
        "lbl_vocaster_routing_apply_hint": "Macht die Vocaster Hub App komplett überflüssig – PunchBuddy schreibt dein Routing nach jedem Start ans Gerät.",
        "btn_vocaster_capture": "Aktuelles Routing speichern",
        "lbl_vocaster_no_routing": "Noch kein Routing gespeichert.",
        "lbl_vocaster_routing_saved": "Letztes Capture: {when} ({model})",
        "lbl_vocaster_routing_workflow": "Workflow: Stelle dein Routing im Vocaster Hub ein, dann klicke „Aktuelles Routing speichern\". PunchBuddy wendet es ab jetzt bei jedem Start an.",
        "msg_routing_captured": "Routing erfolgreich gespeichert.",
        "msg_routing_capture_failed": "Routing-Capture fehlgeschlagen: {err}",
        "save": "Speichern",
        "cancel": "Abbrechen",
        "language": "Sprache:",
        ...
        "msg_manual_not_found_body": "PunchBuddy_Anleitung.html nicht gefunden.\nBitte die Datei neben PunchBuddy.app ablegen.",
        "msg_docs_not_found_title": "Technische Dokumentation nicht gefunden",
        "msg_docs_not_found_body": "PunchBuddy_Technische_Doku.html nicht gefunden.\nBitte die Datei neben PunchBuddy.app ablegen.",
        ...
        "move_audio": "Audio verschieben (Spur 1/2 → 3/4)",
        "lbl_move_audio": "Audio verschieben (Spur-Move)",
        "lbl_move_source": "Quelle",
        "lbl_move_target": "Ziel",
        "btn_move_add_pair": "+ Spurpaar",
        "lbl_move_hint": "Verschiebt das gesamte Material der Quell- auf die Ziel-Spuren (gleiche Zeitposition). Webtrigger: /move_audio",
        "play_custom": "Play KH2 / ST Abh",
        "log_menu_play_custom": ">>> MENU 'Play KH2 / ST Abh' <<<",
    },
    "en": {
        "tab_monitoring": "Monitoring",
        "mon_hdr": "Play Custom – Mute States",
        "mon_desc": "Defines which tracks are muted or unmuted on Play Custom.",
        "mon_col_track": "Track",
        "mon_col_mute_start": "Mute on Play start",
        "mon_col_mute_stop": "Mute on Stop",
        "mon_channel": "Channel",
        ...
        "export_aaf_embedded": "AAF Export (Embedded)",
        "export_aaf_reference": "AAF Export (Reference)",
        "lbl_export_paths": "Export paths (empty = default <session>/export):",
        "lbl_wav_path": "WAV path:",
        "lbl_aaf_emb_path": "AAF embedded path:",
        "lbl_aaf_ref_path": "AAF reference path:",
        "btn_browse": "Browse…",
        "export_interplay": "Interplay Export",
        ...
        "tab_presets": "Presets",
        "tab_vocaster": "Vocaster",
        "lbl_vocaster_device": "Detected device:",
        "lbl_vocaster_phantom_start": "Enable 48V phantom power when PunchBuddy starts",
        "lbl_vocaster_phantom_hint": "Turns on 48V automatically as soon as PunchBuddy launches (all inputs).",
        "lbl_vocaster_autogain_urls": "Autogain web triggers",
        "lbl_vocaster_autogain_host": "Autogain Host",
        "lbl_vocaster_autogain_guest": "Autogain Guest",
        "lbl_vocaster_phantom_on": "Turn 48V on",
        "lbl_vocaster_phantom_off": "Turn 48V off",
        "lbl_vocaster_note": "PunchBuddy controls the Vocaster directly – the Vocaster Hub app is quit on first access.",
        "vocaster_menu_autogain_host": "Vocaster: Autogain Host",
        "vocaster_menu_autogain_guest": "Vocaster: Autogain Guest",
        "vocaster_menu_phantom_on": "Vocaster: Turn 48V on",
        "vocaster_menu_phantom_off": "Vocaster: Turn 48V off",
        "vocaster_menu_save_routing": "Vocaster: Save current routing",
        "lbl_vocaster_routing_hdr": "Audio routing (Hub replacement)",
        "lbl_vocaster_routing_apply_start": "Apply saved routing on startup",
        "lbl_vocaster_routing_apply_hint": "Makes the Vocaster Hub app completely unnecessary – PunchBuddy writes your routing to the device on every start.",
        "btn_vocaster_capture": "Save current routing",
        "lbl_vocaster_no_routing": "No routing saved yet.",
        "lbl_vocaster_routing_saved": "Last capture: {when} ({model})",
        "lbl_vocaster_routing_workflow": "Workflow: Configure your routing in Vocaster Hub, then click \"Save current routing\". PunchBuddy will apply it on every start from now on.",
        "msg_routing_captured": "Routing saved successfully.",
        "msg_routing_capture_failed": "Routing capture failed: {err}",
        "save": "Save",
        "cancel": "Cancel",
        "language": "Language:",
        "col_record_a": "Record A",
        ...
        "msg_manual_not_found_body": "PunchBuddy_Anleitung.html not found.\nPlease place the file next to PunchBuddy.app.",
        "msg_docs_not_found_title": "Technical Documentation Not Found",
        "msg_docs_not_found_body": "PunchBuddy_Technische_Doku.html not found.\nPlease place the file next to PunchBuddy.app.",
        ...
        "move_audio": "Move audio (track 1/2 → 3/4)",
        "lbl_move_audio": "Move Audio (Track Move)",
        "lbl_move_source": "Source",
        "lbl_move_target": "Target",
        "btn_move_add_pair": "+ Track pair",
        "lbl_move_hint": "Moves all material from the source to the target tracks (same time position). Web trigger: /move_audio",
        "play_custom": "Play KH2 / ST Abh",
        "log_menu_play_custom": ">>> MENU 'Play KH2 / ST Abh' <<<",
    },
    "fr": {
        "tab_monitoring": "Monitoring",
        "mon_hdr": "Play Custom – États de mute",
        "mon_desc": "Définit quelles pistes sont mutées ou démutées lors du Play Custom.",
        "mon_col_track": "Piste",
        "mon_col_mute_start": "Mute au démarrage",
        "mon_col_mute_stop": "Mute à l’arrêt",
        "mon_channel": "Canal",
        ...
        "msg_manual_not_found_body": "PunchBuddy_Anleitung.html introuvable.\nVeuillez placer le fichier à côté de PunchBuddy.app.",
        "msg_docs_not_found_title": "Documentation technique introuvable",
        "msg_docs_not_found_body": "PunchBuddy_Technische_Doku.html introuvable.\nVeuillez placer le fichier à côté de PunchBuddy.app.",
        ...
        "move_audio": "Déplacer l'audio (piste 1/2 → 3/4)",
        "lbl_move_audio": "Déplacer l'audio",
        "lbl_move_source": "Source",
        "lbl_move_target": "Cible",
        "btn_move_add_pair": "+ Paire de pistes",
        "lbl_move_hint": "Déplace tout le matériel des pistes source vers les pistes cible (même position temporelle). Déclencheur web : /move_audio",
        "play_custom": "Lecture KH2 / ST Abh",
        "log_menu_play_custom": ">>> MENU 'Lecture KH2 / ST Abh' <<<",
    },
    "es": {
        "tab_monitoring": "Monitorización",
        "mon_hdr": "Play Custom – Estados de silencio",
        "mon_desc": "Define qué pistas se silencian o se activan con Play Custom.",
        "mon_col_track": "Pista",
        "mon_col_mute_start": "Silenciar al iniciar",
        "mon_col_mute_stop": "Silenciar al parar",
        "mon_channel": "Canal",
        ...
        "msg_manual_not_found_body": "PunchBuddy_Anleitung.html no encontrado.\nPor favor, coloque el archivo al lado de PunchBuddy.app.",
        "msg_docs_not_found_title": "Documentación técnica no encontrada",
        "msg_docs_not_found_body": "PunchBuddy_Technische_Doku.html no encontrado.\nPor favor, coloque el archivo al lado de PunchBuddy.app.",
        ...
        "move_audio": "Mover audio (pista 1/2 → 3/4)",
        "lbl_move_audio": "Mover audio",
        "lbl_move_source": "Origen",
        "lbl_move_target": "Destino",
        "btn_move_add_pair": "+ Par de pistas",
        "lbl_move_hint": "Mueve todo el material de las pistas de origen a las de destino (misma posición temporal). Disparador web: /move_audio",
        "play_custom": "Reproducir KH2 / ST Abh",
        "log_menu_play_custom": ">>> MENU 'Reproducir KH2 / ST Abh' <<<",
    },
    "pt": {
        "tab_monitoring": "Monitoramento",
        "mon_hdr": "Play Custom – Estados de mudo",
        "mon_desc": "Define quais faixas são mudas ou reativadas no Play Custom.",
        "mon_col_track": "Faixa",
        "mon_col_mute_start": "Mudo ao iniciar",
        "mon_col_mute_stop": "Mudo ao parar",
        "mon_channel": "Canal",
        "record_a_start": "Iniciar Record A",
        "record_b_start": "Iniciar Record B",
        "play_input": "Play Input",
        ...
        "msg_manual_not_found_body": "PunchBuddy_Anleitung.html não encontrado.\nPor favor, coloque o arquivo ao lado de PunchBuddy.app.",
        "msg_docs_not_found_title": "Documentação técnica não encontrada",
        "msg_docs_not_found_body": "PunchBuddy_Technische_Doku.html não encontrado.\nPor favor, coloque o arquivo ao lado de PunchBuddy.app.",
        ...
        "move_audio": "Mover áudio (faixa 1/2 → 3/4)",
        "lbl_move_audio": "Mover áudio",
        "lbl_move_source": "Origem",
        "lbl_move_target": "Destino",
        "btn_move_add_pair": "+ Par de faixas",
        "lbl_move_hint": "Move todo o material das faixas de origem para as de destino (mesma posição temporal). Gatilho web: /move_audio",
